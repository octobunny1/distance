document.getElementById("showContentButton").addEventListener("click" , function() {
    ...
    if (passwordInput.value === "potato" || passwordInput.value === "1Potato2Icecream.." || passwordInput.value === "1Potato2"  || passwordInput.value === "1potato2icecream." || passwordInput.value === "naruhina") {
